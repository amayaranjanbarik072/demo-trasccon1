...
export default class ProductType extends BasePage {
    private productTypePlusIcon: Locator;
    private productTypeNameTextField: Locator;
    ...
    constructor(page: Page) {
        super(page);
        this.productTypePlusIcon = this.page.locator('xpath = //button[@class="btn btn-primary"]');
        this.productTypeNameTextField = this.page.locator('xpath = //input[@formcontrolname="name"]');
    ...
    async createProductType() {
        ...
        await this.productTypeNameTextField.fill(this.secondaryMasterFakerUtils.generateName('Product Type'));
