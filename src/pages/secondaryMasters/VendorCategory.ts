...
export default class VendorCategory extends BasePage {
    private vendorCategoryPlusIcon: Locator;
    private vendorCategoryNameTextField: Locator;
    ...
    constructor(page: Page) {
        super(page);
        this.vendorCategoryPlusIcon = this.page.locator('xpath = //button[@class="btn btn-primary"]');
        this.vendorCategoryNameTextField = this.page.locator('xpath = //input[@formcontrolname="name"]');
    ...
    async createVendorCategory() {
        ...
        await this.vendorCategoryNameTextField.fill(this.secondaryMasterFakerUtils.generateName('Vendor Category'));
