...
export default class Segment extends BasePage {
    private segmentPlusIcon: Locator;
    private segmentTextField: Locator;
    ...
    constructor(page: Page) {
        super(page);
        this.segmentPlusIcon = this.page.locator('xpath = //button[@class="btn btn-primary"]');
        this.segmentTextField = this.page.locator('xpath = //input[@formcontrolname="name"]');
    ...
    async createSegment() {
        ...
        await this.segmentTextField.fill(this.secondaryMasterFakerUtils.generateName('Segment'));
